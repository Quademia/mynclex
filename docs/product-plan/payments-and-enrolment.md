...
#### OPEN — location-aware default currency (raised 2026-07-15, Sam)
...
Unbuilt. No schema change implied — this is a default-selection concern
on top of the existing dual-price columns.
