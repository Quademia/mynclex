-- =========================================================
-- MyNclex — DEV-ONLY trend wrapper-v2 test seed
-- File: mynclex/db/seed-trend-tests-dev.sql
-- Created: 2026-05-01
--
-- Purpose: exercise every trend dataset kind (5 presets + 1 custom)
-- and every question type (9) in the trend wrapper-v2 UI before
-- slice 14 lands.
--
...
-- All rows tagged batch_id = 'TREND_TEST_2026_05_01'.
--
-- HOW TO LOAD:
--   1. Open Supabase Studio → SQL Editor for the dev project.
--   2. Paste the contents of this file. Click "Run".
--   3. Visit http://localhost:3000/admin/bank/trends-v2 to see the
...
--    WHERE batch_id = 'TREND_TEST_2026_05_01';
--   DELETE FROM nclex_trend_datasets
--    WHERE trend_id LIKE 'NCLEX_TRD_TEST_%';
--
...
INSERT INTO nclex_bank_items (
  ...
  'NCLEX_TRD_TEST_01','TREND_TEST_2026_05_01'
);
...
INSERT INTO nclex_bank_items (
  ...
  FALSE,FALSE,TRUE,1,TRUE,
  'NCLEX_TRD_TEST_02','TREND_TEST_2026_05_01'
);
...
INSERT INTO nclex_bank_items (
  ...
  FALSE,FALSE,TRUE,1,TRUE,
  'NCLEX_TRD_TEST_03','TREND_TEST_2026_05_01'
);
...
INSERT INTO nclex_bank_items (
  ...
  FALSE,FALSE,TRUE,1,TRUE,
  'NCLEX_TRD_TEST_04','TREND_TEST_2026_05_01'
);
...
INSERT INTO nclex_bank_items (
  ...
  FALSE,FALSE,TRUE,1,TRUE,
  'NCLEX_TRD_TEST_05','TREND_TEST_2026_05_01'
);
...
INSERT INTO nclex_bank_items (
  ...
  FALSE,FALSE,TRUE,1,TRUE,
  'NCLEX_TRD_TEST_06','TREND_TEST_2026_05_01'
);
