// mynclex/app/(app)/tutor/bank/cases-v2/page.tsx
//
// Slice 12a — tutor twin of /admin/bank/cases-v2. Reads
        ...
        <header className="auth-list-page-header">
          <div>
            ...
            <p className="auth-list-page-subtitle">
              ...
              under a shared patient chart. The wrapper page is being rebuilt
              in slice 12 — click a row to open the v2 wrapper (stub until 12b).
            </p>
          </div>
              ...
              {cases.map((c) => (
                <tr key={c.case_id}>
                  ...
                  <td className="auth-list-row-actions">
                    <Link href={`/tutor/bank/cases-v2/${c.case_id}`} className="auth-cs-btn tiny">
                      Open →
                    </Link>
                  </td>
                </tr>
