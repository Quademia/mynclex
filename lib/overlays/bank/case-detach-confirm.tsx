// mynclex/lib/overlays/bank/case-detach-confirm.tsx
//
// Floating confirmation dialog for detaching a question from a CASE
...
interface CaseDetachConfirmProps {
  /** 1-based slot position of the question being detached. */
  position: number;
...
export function CaseDetachConfirm({
  position,
  questionType,
  pending = false,
  onCancel,
  onConfirm,
}: CaseDetachConfirmProps) {
  return (
    <div
