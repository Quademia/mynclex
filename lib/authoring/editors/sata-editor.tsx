...
// ─────────────────────────────────────────────────────────────
// SataPreview — pre-submit student view (private). Renders option
// list with square checkboxes instead of radios.
// ─────────────────────────────────────────────────────────────
...
function SataPreview({ instruction, stem, options }: SataPreviewProps) {
  return (
    ...
    >
      ...
      <div className="auth-split">
        ...
        <div className="auth-preview">
          <SataPreview instruction={instruction} stem={stem} options={options} />
        </div>
      </div>
    </form>
  );
