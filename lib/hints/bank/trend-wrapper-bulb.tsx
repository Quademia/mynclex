  ...
  return (
    <Bulb title="What do these buttons do?">
      <ul className="auth-help-bulb-list">
        <li><strong>Cancel changes</strong> — Discard unsaved title / scenario / visibility edits in the Dataset view. Returns those fields to the last saved values. Visible when on the Dataset pill.</li>
        <li><strong>Save trend</strong> — Save the dataset row: title, scenario, and the three visibility flags. The stimulus itself is built from the chart tabs (Charts sub-tab), which save on their own. Visible when on the Dataset pill.</li>
