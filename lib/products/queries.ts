...
export const PRODUCT_COLUMNS =
  'product_id, name, kind, pack_type, duration_days, readiness_credits, cat_allowance, price_minor_ghs, price_minor_usd, full_price_minor_ghs, full_price_minor_usd, status, sort_order, badge';
