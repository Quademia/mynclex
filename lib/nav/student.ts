...
export const STUDENT_PROGRAMME_DETAIL_NAV: NavItem[] = [
  ...
  { key: 'history',    label: 'Quiz History', icon: 'clock',  href: '/student/programme/:programmeId/history', mobileTab: true, tabLabel: 'History' },
];
...
export const STUDENT_COHORT_DETAIL_NAV: NavItem[] = [
  ...
  { key: 'quizzes',    label: 'Quizzes',      icon: 'book',   href: '/student/cohort/:cohortId/quizzes', mobileTab: true },
